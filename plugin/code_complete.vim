...
let g:template['c']['switch1'] = "switch(".g:rs."...".g:re.")\<cr>{\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"default:\<cr>break;\<cr>}"
let g:template['c']['switch2'] = "switch(".g:rs."...".g:re.")\<cr>{\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"default:\<cr>break;\<cr>}"
let g:template['c']['switch3'] = "switch(".g:rs."...".g:re.")\<cr>{\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"default:\<cr>break;\<cr>}"
let g:template['c']['switch4'] = "switch(".g:rs."...".g:re.")\<cr>{\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
            \"case ".g:rs."...".g:re.":\<cr>break;\<cr>".
...
let g:template['c']['f2']=g:rs."...".g:re."(".g:rs."...".g:re.", ".
            \g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['f3']=g:rs."...".g:re."(".g:rs."...".g:re.", ".
            \g:rs."...".g:re.", ".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
